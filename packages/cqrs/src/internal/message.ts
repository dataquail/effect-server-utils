...
export type TypeId = "~@effect-server-utils/cqrs/Message";
const TypeId: TypeId = "~@effect-server-utils/cqrs/Message";

export type GroupTypeId = "~@effect-server-utils/cqrs/MessageGroup";
const GroupTypeId: GroupTypeId = "~@effect-server-utils/cqrs/MessageGroup";
